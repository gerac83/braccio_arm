...
public:
  ...
  *@param speed: motor speed (0=full speed, 1-255 slower to faster)
...
private:
  ...
  */
  ...
  // Deafult speed for all motors {base, shoulde, elbow, wrist vertical, wrist rotation, gripper}
  int motor_speed[6] = {HALF_SPEEP_MOTOR, HALF_SPEEP_MOTOR, HALF_SPEEP_MOTOR, HALF_SPEEP_MOTOR, HALF_SPEEP_MOTOR, HALF_SPEEP_MOTOR};
